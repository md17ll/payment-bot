...
if not BOT_TOKEN or not ADMIN_ID:
    raise RuntimeError("Missing BOT_TOKEN or ADMIN_ID in Railway Variables.")
if not NOWPAYMENTS_API_KEY or not NOWPAYMENTS_IPN_SECRET:
    raise RuntimeError("Missing NOWPAYMENTS keys in Railway Variables.")
...
# ============ FASTAPI ============
app = FastAPI()
tg_app: Application | None = None  # set later
...
def main():
    ...
    # Start telegram bot polling (most reliable)
